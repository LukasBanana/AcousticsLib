...
class AC_EXPORT AudioSystem
{
    ...
    public:
        ...
        */
        ...
        /**
        \brief Unloads the specified audio system and the internal module.
        \remarks After this call, the specified audio system and all the objects associated to it must no longer be used!
        */
        static void Unload(std::unique_ptr<AudioSystem>&& audioSystem);
